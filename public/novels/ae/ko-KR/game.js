...
function processAction(act, gotoScene, gotoAction, skipKey, loadKey2) {
  ...
  switch (act.nodeName) {
    case 'cg':
      ...
      $('.cg')
        .unbind()
        .css('background', "url('" + getResourceUrl('cg', act.getAttribute('src')) + "') no-repeat")
        .css('background-size', 'auto 100%')
        .css('background-position', 'center')
        .fadeIn(fadeInTimeCG)
...
function preLoadImagesBegin(imageList) {
  ...
  for (var i = 0; i < i_max; i++) {
    ...
    var $tempImage = $('<img></img>')
    var tempSrc = getResourceUrl(imageList[i].getAttribute('type'), imageList[i].getAttribute('src'))
...
function add_record() {
  ...
  $('#confirm_1').css('background', "url('/novels/ae/ko-KR/quicksave.webp') no-repeat")
...
function get_record() {
  ...
  $('#confirm_1').css('background', "url('/novels/ae/ko-KR/quickload.webp') no-repeat")
  $('#confirm_1').css('background-size', 'auto 100%')
  $('#confirm_1').css('background-position', 'center')
  $('#confirm').fadeIn()
}
...
function showCgOrigin(str) {
  $('.showCgOrigin').css('background-image', "url('" + getResourceUrl('cg', str) + "')")
  $('.showCgOrigin').fadeIn()
}
